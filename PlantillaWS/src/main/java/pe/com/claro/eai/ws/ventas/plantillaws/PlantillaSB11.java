...
@WebService(portName = "ebsPlantillaSB11", serviceName = "PlantillaWSService", targetNamespace = "http://claro.com.pe/eai/ws/ventas/plantillaws", wsdlLocation = "/WEB-INF/wsdl/PlantillaWS.wsdl", endpointInterface = "pe.com.claro.eai.ws.ventas.plantillaws.PlantillaWSPortType")
@BindingType(SOAPBinding.SOAP11HTTP_BINDING)
public class PlantillaSB11 implements PlantillaWSPortType {
